...

{
  ...
  formSelfEmployment.addEventListener(
    "input",
    debounceTimer(() => {
      const individualValue = +formSelfEmployment.individual.value;
      const entityValue = +formSelfEmployment.entity.value;
...

{
  ...
  formUsn.addEventListener(
    ...
    debounceTimer(() => {
      ...
      if (formUsn.typeTax.value !== "i-income") {
        profit -= expenses;
      }
